...
-- create the TMS_LOA_LNE_DRP_APP_DAT column:
SELECT
    -- create the SHP_LEG_PIC_TRL_LOA_TYP_DSC column:
    TMS_LOA_LNE.SHP_LEG_PIC_TRL_LOA_TYP_DSC SHP_LEG_PIC_TRL_LOA_TYP_DSC,
    -- create the SHP_LEG_PIC_TRL_LOA_TYP_DSC column:
    TMS_LOA_LNE.SHP_CBU_REF_DOC_TYP AS SHP_LEG_PIC_TRL_LOA_TYP_DSC,
    -- create the SCH_TEM_COD column:
    TMS_LOA_LNE.SCH_TEM_COD AS SCH_TEM_COD,
    -- create the MAT_TYP_COD column:
    TMS_LOA_LNE.MAT_TYP_COD AS MAT_TYP_COD,
    -- create the LOA_IDT_COD column:
    TMS_LOA_LNE.LOA_IDT_COD AS LOA_IDT_COD,
    -- create the SHP_LEG_IDT_COD column:
    TMS_LOA_LNE.SHP_LEG_IDT_COD AS SHP_LEG_IDT_COD,
    -- create the SHP_LEG_DRP_APP_DAT column:
    TMS_LOA_LNE.SHP_LEG_DRP_APP_DAT AS SHP_LEG_DRP_APP_DAT,
    -- create the TMS_LOA_LNE_DRP_APP_DAT column:
    CASE 
    ...
    -- create the SAL_ORG_COD column:
    TMS_LOA_LNE.SAL_ORG_COD AS SAL_ORG_COD,
    -- create the DIS_CHL_COD column:
    TMS_LOA_LNE.DIS_CHL_COD AS DIS_CHL_COD,
    -- create the CUS_COD column:
    TMS_LOA_LNE.SHP_LEG_DRP_CUS_COD AS CUS_COD,
    -- create the TMS_LOA_LNE_PIC_APP_DAT column:
    CASE
    ...
    -- create the SHP_LEG_DRP_APP_TIM column:
    ...
    -- create the SHP_LEG_DRP_APP_WIN_END_TIM column:
    ...
    -- create the SHP_LEG_DRP_ARV_TIM column:
    ...
    -- create the SHP_LEG_DRP_CTY_DSC column:
    TMS_LOA_LNE.SHP_LEG_DRP_CTY_DSC AS SHP_LEG_DRP_CTY_DSC,
    -- create the SHP_LEG_DRP_CRY_COD, column:
    TMS_LOA_LNE.SHP_LEG_DRP_CRY_COD AS SHP_LEG_DRP_CRY_COD,
    -- create the SHP_LEG_DRP_WIN_BGN_TIM column:
    ...
    -- create the SHP_LEG_DRP_ADU_TIM column:
    ...
    -- create the SHP_LEG_DRP_DCK_END_TIM column:
    ...
    -- create column: SHP_LEG_DRP_DCK_BGN_TIM:
    ...
    SUM((
            ...
            END)) AS WJXBFS5,
    -- create the ORD_CNT_OTD_FLG column:
    MAX((
            CASE
                WHEN
                    CASE
                ...
                THEN
                    ...
                    END
                ELSE NULL
            END)) AS ORD_CNT_OTD_FLG,
    -- create the ORD_CAR column:
    SUM(
        CASE
            WHEN TMS_LOA_LNE.SAL_ORG_COD IN ('1000',
                                             '1400')
            ...
            ELSE TMS_LOA_LNE.SHP_LEG_DRP_ORD_CAR_CSL_QTY
        END) AS ORD_CAR,
    -- create the ORD_CAS_CUS_DEL column:
    SUM(
        CASE
            WHEN TMS_LOA_LNE.LOA_CUS_PIC_FLG = 'CARRIER SHIPMENT'
            THEN TMS_LOA_LNE.SHP_LEG_DRP_ORD_CAR_CSL_QTY
            ELSE 0
        END) AS ORD_CAS_CUS_DEL,
    -- create the ORD_CAS_CUS_PIC column:
    SUM(
        CASE
            WHEN TMS_LOA_LNE.LOA_CUS_PIC_FLG = 'CUST PICKUP'
            THEN TMS_LOA_LNE.SHP_LEG_DRP_ORD_CAR_CSL_QTY
            ELSE 0
        END) AS ORD_CAS_CUS_PIC,
    -- create the SHP_CAR column:
    SUM(
        CASE
            WHEN TMS_LOA_LNE.SHP_LEG_DRP_DEL_CAR_CSL_QTY > 0
            THEN TMS_LOA_LNE.SHP_LEG_DRP_DEL_CAR_CSL_QTY
            ELSE TMS_LOA_LNE.SHP_CAR_NBR
        END) AS SHP_CAR,
    -- create the SHP_NET_LBS_CUS_DEL column:
    SUM(
        CASE
            WHEN TMS_LOA_LNE.LOA_CUS_PIC_FLG = 'CARRIER SHIPMENT'
            THEN TMS_LOA_LNE.SHP_LEG_DRP_DEL_NET_WGH_LBS_CSL_VAL
            ELSE 0
        END) AS SHP_NET_LBS_CUS_DEL,
    -- create the SHP_NET_LBS_IM column:
    SUM(
        CASE
            WHEN TMS_LOA_LNE.LOA_TRP_MDE_DSC = 'IM'
            THEN TMS_LOA_LNE.SHP_LEG_DRP_DEL_NET_WGH_LBS_CSL_VAL
            ELSE 0
        END) AS SHP_NET_LBS_IM,
    -- create the SHP_NET_LBS_LTL column:
    SUM(
        CASE
            WHEN TMS_LOA_LNE.LOA_TRP_MDE_DSC = 'LTL'
            THEN TMS_LOA_LNE.SHP_LEG_DRP_DEL_NET_WGH_LBS_CSL_VAL
            ELSE 0
        END) AS SHP_NET_LBS_LTL,
    -- create the SHP_NET_LBS_TL column:
    SUM(
        CASE
            WHEN TMS_LOA_LNE.LOA_TRP_MDE_DSC = 'TL'
            THEN TMS_LOA_LNE.SHP_LEG_DRP_DEL_NET_WGH_LBS_CSL_VAL
            ELSE 0
        END) AS SHP_NET_LBS_TL,
    -- create the SHP_GRS_VOL column:
    SUM(
        CASE
            WHEN TMS_LOA_LNE.SHP_CNY_DSC = 'DANNON COMPANY'
            OR  TMS_LOA_LNE.SHP_CNY_DSC = 'STONYFIELD FARM, INC.'
            ...
            ELSE
                ...
                END
        END) AS SHP_GRS_VOL,
    -- create the SHP_GRS_VOL_CUS_DEL column:
    SUM(
        CASE
            WHEN TMS_LOA_LNE.LOA_CUS_PIC_FLG = 'CARRIER SHIPMENT'
            AND (TMS_LOA_LNE.SHP_CNY_DSC = 'DANNON COMPANY'
            ...
            ELSE
                CASE
                    ...
                    ELSE 0
                END
        END) AS SHP_GRS_VOL_CUS_DEL,
    -- create the SHP_GRS_VOL_IM column:
    SUM(
        CASE
            WHEN TMS_LOA_LNE.LOA_TRP_MDE_DSC = 'IM'
            AND (TMS_LOA_LNE.SHP_CNY_DSC = 'DANNON COMPANY'
            ...
            ELSE
                CASE
                    ...
                    ELSE 0
                END
        END) AS SHP_GRS_VOL_IM,
    -- create the SHP_GRS_VOL_LTL column:
    SUM(
        CASE
            WHEN TMS_LOA_LNE.LOA_TRP_MDE_DSC = 'LTL'
            AND (TMS_LOA_LNE.SHP_CNY_DSC = 'DANNON COMPANY'
            ...
            ELSE
                CASE
                    ...
                    ELSE 0
                END
        END) AS SHP_GRS_VOL_LTL,
    -- create the SHP_GRS_VOL_TL column:
    SUM(
        CASE
            WHEN TMS_LOA_LNE.LOA_TRP_MDE_DSC = 'TL'
            AND (TMS_LOA_LNE.SHP_CNY_DSC = 'DANNON COMPANY'
            ...
            ELSE
                CASE
                    ...
                    ELSE 0
                END
        END) AS SHP_GRS_VOL_TL,
    -- create the SHP_NET_VOL column:
    SUM(
        CASE
            WHEN TMS_LOA_LNE.SHP_CNY_DSC = 'DANNON COMPANY'
            OR  TMS_LOA_LNE.SHP_CNY_DSC = 'STONYFIELD FARM, INC.'
...
FROM DEV_NAM.NAM_DWH.V_PBI_D_TMSth