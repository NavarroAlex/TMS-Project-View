-- select columns:
SELECT
    -- create the GROS_WGH_CAR_Bracket column:
    CASE
      WHEN SUM(TMS_LOA_LNE.SHP_LEG_DRP_DEL_GRS_WGH_WTH_CAR_LBS_CSL_VAL) < 3000 THEN '3000' -- first condition:
      WHEN SUM(TMS_LOA_LNE.SHP_LEG_DRP_DEL_GRS_WGH_WTH_CAR_LBS_CSL_VAL) >= 3000 -- second condition:
      AND SUM(TMS_LOA_LNE.SHP_LEG_DRP_DEL_GRS_WGH_WTH_CAR_LBS_CSL_VAL) <= 7000 THEN '3000-7000'
      WHEN SUM(TMS_LOA_LNE.SHP_LEG_DRP_DEL_GRS_WGH_WTH_CAR_LBS_CSL_VAL) >= 7000 -- third condition:
      AND SUM(TMS_LOA_LNE.SHP_LEG_DRP_DEL_GRS_WGH_WTH_CAR_LBS_CSL_VAL) <= 20000 THEN '7000-20000'
      WHEN SUM(TMS_LOA_LNE.SHP_LEG_DRP_DEL_GRS_WGH_WTH_CAR_LBS_CSL_VAL) >= 20000 -- fourth condition:
      AND SUM(TMS_LOA_LNE.SHP_LEG_DRP_DEL_GRS_WGH_WTH_CAR_LBS_CSL_VAL) <= 30000 THEN '20000-30000'
      WHEN SUM(TMS_LOA_LNE.SHP_LEG_DRP_DEL_GRS_WGH_WTH_CAR_LBS_CSL_VAL) >= 30000 -- fifth condition:
      AND SUM(TMS_LOA_LNE.SHP_LEG_DRP_DEL_GRS_WGH_WTH_CAR_LBS_CSL_VAL) <= 39000 THEN '30000-39000'
      WHEN SUM(TMS_LOA_LNE.SHP_LEG_DRP_DEL_GRS_WGH_WTH_CAR_LBS_CSL_VAL) > 39000 THEN 'Greater Than 39000' -- sixth condition:
      END AS "GRS_WGH_CAR_Bracket",
    -- create id_lane column:
    CONCAT(TMS_LOA_LNE.SHP_LEG_PIC_CBU_COD, TMS_LOA_LNE.SHP_LEG_DRP_CBU_COD) AS ID_Lane,
    ...
    ) AS "Origin-Destination Lane",
    -- create Origin City/State Column:
    CONCAT(
        TMS_LOA_LNE.SHP_LEG_PIC_CTY_DSC,
        ', ',
        TMS_LOA_LNE.SHP_LEG_PIC_STE_COD
    ) AS "Origin City/State",
    -- create In-Gate Data Available? column:
    CASE WHEN YEAR(TMS_LOA_LNE.SHP_LEG_DRP_ARV_GTE_TIM) = 1000 THEN 'No' ELSE 'Yes' END AS "In-Gate Date Available?",
    -- create Destination City/State column:
    CONCAT(
        TMS_LOA_LNE.SHP_LEG_DRP_CTY_DSC,
        ', ',
        TMS_LOA_LNE.SHP_LEG_DRP_STE_COD
    ) AS "Destination City/State",
    ...
    ) AS "Origin Name - City/State - Destination Name - City/State",
    ...
    CASE
        WHEN "Shuttle (Y/N)" = 'Shuttle' THEN TMS_LOA_LNE.SHP_LEG_PIC_NAM_COD
        ELSE '0'
    END AS "Shuttle Origin",
    -- create Shuttle Cost column: first condition:
    CASE
        WHEN "Shuttle Origin" = 'MINSTER' THEN 64 -- second condition:
        WHEN "Shuttle Origin" = '0030 US YC PL Portland'
        OR "Shuttle Origin" = 'AMC SALEM' THEN 429 -- third condition:
        WHEN "Shuttle Origin" = 'FORT WORTH MFG' THEN 217 -- fourth condition:
        WHEN "Shuttle Origin" = 'WEST JORDAN MFG' THEN 106 -- else:
        ELSE 0
    END AS "Shuttle Cost",
    -- create Linehaul with Shuttle column:
    IFNULL(ROUND((LIN_HUL + "Shuttle Cost"), 2), 0) AS "Linehaul with Shuttle",
    ...
    END AS "Destination Name/Campus",
    ...
    CONCAT(
        ...
        ', ',
        "Destination City/State"
    ) AS "Origin Campus - Destination Campus/City Lane",
    -- create the Origin Campus - City/State Lane column:
    CONCAT(
        "Origin Name/Campus",
        '- ',
        "Destination City/State"
    ) AS "Origin Campus - City/State Lane",
    -- create the "Origin Campus - Destination State Lane" column:
    CONCAT("Origin Name/Campus", '_', TMS_LOA_LNE_DST_CPS.DST_STE_ID) AS "Origin Campus - Destination State Lane",
    ...
    CASE
        ...
        ELSE "Origin City/State"
    END AS "RFG Origin Region",
    ...
    CASE
        ...
        ELSE "Destination City/State"
    END AS "RFG Destination Region",
    ...
    CASE
        WHEN "Lead Time" <= 1 THEN '<24 Hrs' -- create Lead Time Category column: second condition:
        WHEN "Lead Time" < 3 THEN '<72 Hrs' -- create Lead Time Category column: third condition:
        WHEN "Lead Time" >= 3 THEN '>72 Hrs' -- else:
        ELSE NULL
    ...
    MAX(TO_DATE(TO_CHAR(TMS_LOA_LNE.SHP_SAL_CUS_PUR_DOC_DAT),'yyyymmdd')) AS SHP_SAL_CUS_PUR_DOC_DAT_TIM,
    ...
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_DRP_WIN_BGN_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_DRP_WIN_BGN_TIM END AS SHP_LEG_DRP_WIN_BGN_TIM,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_DRP_ADU_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_DRP_ADU_TIM END AS SHP_LEG_DRP_ADU_TIM,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_DRP_DCK_END_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_DRP_DCK_END_TIM END AS SHP_LEG_DRP_DCK_END_TIM,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_DRP_DCK_BGN_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_DRP_DCK_BGN_TIM END AS SHP_LEG_DRP_DCK_BGN_TIM,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_DRP_ARV_GTE_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_DRP_ARV_GTE_TIM END AS SHP_LEG_DRP_ARV_GTE_TIM,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_DRP_DEP_GTE_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_DRP_DEP_GTE_TIM END AS SHP_LEG_DRP_DEP_GTE_TIM,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_DRP_LOA_END_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_DRP_LOA_END_TIM END AS SHP_LEG_DRP_LOA_END_TIM,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_DRP_LOA_BGN_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_DRP_LOA_BGN_TIM END AS SHP_LEG_DRP_LOA_BGN_TIM,
    ...
    CASE
        ...
        THEN TMS_LOA_LNE.SHP_LEG_DRP_CBU_COD
        ELSE '#'
    ...
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_PIC_DCK_BGN_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_PIC_DCK_BGN_TIM END AS SHP_LEG_PIC_DCK_BGN_TIM,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_PIC_ARV_GTE_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_PIC_ARV_GTE_TIM END AS SHP_LEG_PIC_ARV_GTE_TIM,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_PIC_DEP_GTE_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_PIC_DEP_GTE_TIM END AS SHP_LEG_PIC_DEP_GTE_TIM,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_PIC_LOA_END_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_PIC_LOA_END_TIM END AS SHP_LEG_PIC_LOA_END_TIM,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_PIC_LOA_BGN_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_PIC_LOA_BGN_TIM END AS SHP_LEG_PIC_LOA_BGN_TIM,
        ...
        CASE
            ...
            ELSE
                CASE
                    ...
                    ELSE 1
                END
        END) OT_APP_FOR_CAR_SHP_2HR_DEN,
    SUM(
        CASE
            WHEN (TMS_LOA_LNE.LOA_CUS_PIC_FLG <> 'CARRIER SHIPMENT')
            OR  (TMS_LOA_LNE.SHP_LEG_PIC_ARV_DAT = 10000101)
            ...
            ELSE
                CASE
                    ...
                    ELSE 0
                END
        END) OT_APP_PIK_FOR_CAR_SHP_2HR,
    SUM((
            CASE
    ...
    SUM(
        CASE
            ...
            THEN 0
            ELSE 1
        END) OTD_APP_PIK_FOR_CPU_2HR_DEN,
    SUM(
        CASE
            WHEN (TMS_LOA_LNE.LOA_CUS_PIC_FLG <> 'CUST PICKUP')
            OR  (TMS_LOA_LNE.SHP_LEG_PIC_ARV_GTE_DAT = 10000101)
        ...
        CASE
            ...
            ELSE
                CASE
                    ...
                    ELSE 0
                END
        END) OT_APP_PIK_FOR_CAR_SHP_05HR,
    MAX(
        CASE
            WHEN (TMS_LOA_LNE.LOA_CUS_PIC_FLG <> 'CARRIER SHIPMENT')
            OR  (TMS_LOA_LNE.SHP_LEG_DRP_ARV_DAT = 10000101)
        ...
        CASE
            ...
            ELSE
                CASE
                    ...
                    ELSE 0
                END
        END)                                                                    OTD_APP_CAR_SHP_6HR,
    SUM((TMS_LOA_LNE.SHP_LEG_STP_RTE_LGT_NBR * TMS_LOA_LNE.SHP_LEG_STP_WGH_RAT)) LAN_MLS,
    SUM(
        CASE
            WHEN (TMS_LOA_LNE.LOA_CUS_PIC_FLG <> 'CARRIER SHIPMENT')
            OR  (TMS_LOA_LNE.SHP_LEG_DRP_ARV_DAT = 10000101)
        ...
        CASE
            ...
            ELSE
                CASE
                    ...
                    ELSE NULL
                END
        END) OT_ORI_RQT_DEL_FOR_CAR_SHP,
    SUM(
        CASE
            WHEN (TMS_LOA_LNE.LOA_CUS_PIC_FLG <> 'CARRIER SHIPMENT')
            OR  (TMS_LOA_LNE.SHP_LEG_PIC_ARV_DAT = 10000101)
        ...
        CASE
            ...
            ELSE
                CASE
                    ...
                    ELSE NULL
                END
        END)                                                     OT_RQT_DEL_FOR_CAR_SHP,
    SUM(TMS_LOA_LNE.SHP_LEG_DRP_DEL_GRS_WGH_WTH_CAR_LBS_CSL_VAL) GRS_WGH_CAR_LBS,
    MAX(
        CASE
            WHEN (TMS_LOA_LNE.LOA_CUS_PIC_FLG <> 'CARRIER SHIPMENT')
            OR  (TMS_LOA_LNE.SHP_LEG_DRP_ARV_DAT = 10000101)
            ...
            CASE
                WHEN
                    CASE
                        ...
                        OR  TMS_LOA_LNE.SHP_LEG_DRP_ARV_TIM ='1000-01-01 00:00:00'
                        THEN 0
                        ELSE 1
                    END IN (1)
                THEN
    ...
    SUM(
        CASE
            ...
            OR  TMS_LOA_LNE.SHP_CNY_DSC = 'WHITEWAVE FOODS'
            OR  TMS_LOA_LNE.SHP_CNY_DSC = 'DANONE NA'
            AND (TMS_LOA_LNE.SHP_LEG_DRP_DEL_GRS_WGH_LBS_CSL_VAL > 0)
            THEN TMS_LOA_LNE.SHP_LEG_DRP_DEL_GRS_WGH_LBS_CSL_VAL
            ELSE
                CASE
                    ...
                    OR  TMS_LOA_LNE.SHP_CNY_DSC = 'WHITEWAVE FOODS'
                    AND ( TMS_LOA_LNE.SHP_LEG_DRP_DEL_GRS_WGH_KGR_CSL_VAL > 0)
                    THEN TMS_LOA_LNE.SHP_LEG_DRP_DEL_GRS_WGH_KGR_CSL_VAL
                    ELSE 0
                END
        END) SHP_GRS_VOL,
    SUM(
        CASE
            ...
            ELSE
                CASE
                    WHEN TMS_LOA_LNE.LOA_CUS_PIC_FLG = 'CARRIER SHIPMENT'
                    AND ( TMS_LOA_LNE.SHP_CNY_DSC = 'DANONE CANADA'
                        OR  TMS_LOA_LNE.SHP_CNY_DSC = 'DANONE WATERS OF AMERICA')
                    THEN TMS_LOA_LNE.SHP_LEG_DRP_DEL_GRS_WGH_KGR_CSL_VAL
                    ELSE 0
                END
        END) SHP_GRS_VOL_CUS_DEL,
    SUM(
        CASE
            WHEN TMS_LOA_LNE.LOA_TRP_MDE_DSC = 'IM'
            AND (TMS_LOA_LNE.SHP_CNY_DSC = 'DANNON COMPANY'
        ...
        CASE
            ...
            ELSE
                CASE
                    ...
                    ELSE NULL
                END
        END) OTD_APP_FOR_CAR_SHP_0HR_DEN_DRP,
    MAX(
        CASE
            WHEN TMS_LOA_LNE.LOA_CUS_PIC_FLG <> 'CARRIER SHIPMENT'
            OR  TMS_LOA_LNE.SHP_LEG_DRP_ARV_DAT = 10000101
            ...
            ELSE
                CASE
                    ...
                    ELSE NULL
                END
        END) OTD_APP_FOR_CAR_SHP_05HR_DEN_DRP,
    MAX(
        CASE
            WHEN TMS_LOA_LNE.LOA_CUS_PIC_FLG <> 'CARRIER SHIPMENT'
            OR  TMS_LOA_LNE.SHP_LEG_DRP_ARV_DAT = 10000101
            ...
            ELSE
                CASE
                    ...
                    ELSE NULL
                END
        END) OTD_APP_FOR_CAR_SHP_6HR_DEN_DRP,
    MAX(
        CASE
            WHEN TMS_LOA_LNE.SHP_LEG_PIC_TRL_LOA_TYP_COD = 2
            THEN NULL
            ELSE
                CASE
                    ...
                    ELSE
                        ...
                        END
                END
        END ) OTD_APP_PIK_UP_FOR_CAR_SHP_0HR,
    MAX(
        CASE
            WHEN TMS_LOA_LNE.LOA_CUS_PIC_FLG <> 'CARRIER SHIPMENT'
            OR  TMS_LOA_LNE.SHP_LEG_PIC_ARV_DAT = 10000101
            ...
            ELSE
                CASE
                    ...
                    ELSE 0
                END
        END) OTD_APP_PIK_UP_FOR_CAR_SHP_05HR,
    MAX(
        CASE
            WHEN TMS_LOA_LNE.LOA_CUS_PIC_FLG <> 'CARRIER SHIPMENT'
            OR  TMS_LOA_LNE.SHP_LEG_PIC_ARV_DAT = 10000101
            ...
            ELSE
                CASE
                    ...
                    ELSE 0
                END
        END) OTD_APP_PIK_UP_FOR_CAR_SHP_2HR ,
    SUM(
        CASE
            WHEN TMS_LOA_LNE.LOA_CUS_PIC_FLG <> 'CARRIER SHIPMENT'
            OR  TMS_LOA_LNE.SHP_LEG_PIC_ARV_GTE_DAT = 10000101
            THEN 0
            WHEN TMS_LOA_LNE.SHP_LEG_PIC_ARV_GTE_DAT <= TMS_LOA_LNE.SHP_LEG_DRP_INI_RQT_DEL_DAT
            THEN 1
            ELSE 0
        END) OTD_ORI_REQ_CPU,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'AF'
            THEN 1
            ELSE 0
        END) ACD,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'AZ'
            THEN 1
            ELSE 0
        END) ALT_CAR_DEL,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'D1'
            THEN 1
            ELSE 0
        END) CAR_DIS_ERR,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'BF'
            THEN 1
            ELSE 0
        END) CAR_KEY_ERR,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'B1'
            THEN 1
            ELSE 0
        END) CON_CLO,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'AG'
            THEN 1
            ELSE 0
        END) CON_RLD,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'C2'
            THEN 1
            ELSE 0
        END) CRD_HLD,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'AD'
            THEN 1
            ELSE 0
        END) CUS_REQ_FTR_DEL,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'BJ'
            THEN 1
            ELSE 0
        END) CUS_WAN_ERL_DEL,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'CA'
            THEN 1
            ELSE 0
        END) CUS_IMP_EXP,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'S1'
            THEN 1
            ELSE 0
        END) DEL_SRT,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'D2'
            THEN 1
            ELSE 0
        END) DRV_NOT_AVL,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'AH'
            THEN 1
            ELSE 0
        END) DRV_RLD,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'AV'
            THEN 1
            ELSE 0
        END) EXC_SRV,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'BB'
            THEN 1
            ELSE 0
        END) HEL_PER_SHP,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'AN'
            THEN 1
            ELSE 0
        END) HOL_CLO,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'A2'
            THEN 1
            ELSE 0
        END) ICR_Add,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'A3'
            THEN 1
            ELSE 0
        END) IDR_DEL,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'T7'
            THEN 1
            ELSE 0
        END) ISF_DEL_TIM,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'AX'
            THEN 1
            ELSE 0
        END) ISF_PIK_UP_TIM,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'BH'
            THEN 1
            ELSE 0
        END) ISF_TIM_CPL_DEL,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'BP'
            THEN 1
            ELSE 0
        END) LOA_SHF,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'AI'
            THEN 1
            ELSE 0
        END) MEC_BRK,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'AA'
            THEN 1
            ELSE 0
        END) MIS_SRT,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'A1'
            THEN 1
            ELSE 0
        END) MIS_DEL,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'AYU'
            THEN 1
            ELSE 0
        END) MIS_PIK_UP,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'BG'
            THEN 1
            ELSE 0
        END) OTH,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'AJ'
            THEN 1
            ELSE 0
        END) OTH_CAR_REL,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'BK'
            THEN 1
            ELSE 0
        END) PRA_APT,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'AL'
            THEN 1
            ELSE 0
        END) PRV_STP,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'P3'
            THEN 1
            ELSE 0
        END) PDT_FAL,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'BO'
            THEN 1
            ELSE 0
        END) RIL_FAI_MET_SCH,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'BS'
            THEN 1
            ELSE 0
        END) RFS_BY_CUS,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'BE'
            THEN 1
            ELSE 0
        END) ROD_CDT,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'AM'
            THEN 1
            ELSE 0
        END) SHP_REL,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'T5'
            THEN 1
            ELSE 0
        END) TRL_CLS_NOT_AVL,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'T3'
            THEN 1
            ELSE 0
        END) TRL_NOT_AVL,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'T4'
            THEN 1
            ELSE 0
        END) TRL_NOT_USA_PRI_PDT,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'T2'
            THEN 1
            ELSE 0
        END) TRL_CVT_NOT_AVL,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'BR'
            THEN 1
            ELSE 0
        END) TRN_DER,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'A5'
            THEN 1
            ELSE 0
        END) NBL_LOC,
    SUM(
        CASE
            WHEN TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'A0'
            THEN 1
            ELSE 0
        END) AS WTH_NAT_DIS_REL,
    ...
    SUM(
        CASE
            ...
            OR  TMS_LOA_LNE.SHP_CNY_SAL_ORG_COD = '1000'
            THEN TMS_LOA_LNE_CRG.SND_DAY_DEL
            ELSE 0
        END) AS SND_DAY_DEL,
...
FROM
    V_PBI_D_TMS_LOA_LNE TMS_LOA_LNE
...
LEFT JOIN
    (
        SELECT
            ...
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = '18D'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) ADD_DAY,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'CUS3'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) CUS_DCT,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'APT'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) APP_FEE,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'BAS'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) bas_lhl_dol,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'DTL'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) dtl_dtn_at_ori_dol,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'DTU'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) dtl_dtn_at_DEL_dol,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'GST'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) gst_grl_sal_tax_dol,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'HAR'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) har_hrm_sal_tax_dol,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'NB_HST'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) nb_hst_new_brk_tax_dol,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'NL_HST'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) nl_hst_nFd_tax_dol,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'NS_HST'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) ns_hst_nov_sct_tax_dol,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'ON_HST'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) on_hst_ont_tax_dol,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'QC_PST'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) qc_pst_qbc_tax_dol,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'SOC'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) soc_stp_off_dol,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'UND'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) und_uld_lmp_dol,
            SUM(
                CASE
                    ...
                    OR  TMS_LOA_LNE_CRG.SHP_CNY_SAL_ORG_COD = '1000'
                    THEN (
                            CASE
                                WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'BAS'
                                THEN TMS_LOA_LNE_CRG.PAY_VAL
            ...
            SUM(
                CASE
                    ...
                    THEN (
                            CASE
                                WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'CUS2'
                                THEN TMS_LOA_LNE_CRG.PAY_VAL
                                ELSE 0
                            END)
                    ELSE 0
            ...
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'BEY'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) BNR_FRT,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'CUS8'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) CA_FUL_TAX,
            SUM(
            ...
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'PPC'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) CRS_DCK_SRG,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'CNS'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) CRS_DCK_SPT_FRT_CLD,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'CUS10'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) CUS_REF_FSC,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'DMC'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) DAD_HAD,
            SUM(
            ...
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = '260'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) DEL_SRG,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'DET'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) DTN,
            SUM(
            ...
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'DTV'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) DTV_VHC_DTN,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = '315'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) DTY_CHG,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'CUS4'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) EMS_SRG,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'ELC'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) XTR_LBR,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'FUE'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) FUE_MDF_FSC,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'n/a'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) FUL_ADJ_FOR_WST_CND,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = '405'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) FUL_SRG,
            SUM(
            ...
            SUM(
                CASE
                    ...
                    THEN (
                            ...
                            END)
                    ELSE 0
                END) GST_ON_GNL_SAL_TAX,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'IDL'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) INS_DEL,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'LAD'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) LBR_RPR_AND_RTN_ORD,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'LAY'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) LAY,
            SUM(
            ...
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'LUMPER'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) LMP,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'DCT'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) MTR_ARA_FEE,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'MIC'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) MIN_DEL_CHG,
            SUM(
            ...
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'FLC'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) NIG_DEL,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'MNC'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) NOT_PRI_TO_DEL,
            SUM(
            ...
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'CUS5'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) OFF_HRS_DEL,
            SUM(
            ...
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = '999'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) OTR_CHG,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'ORM'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) OUT_OF_RUT_MLS,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'PUC'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) PIK_CHG,
            SUM(
            ...
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'RCC'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) RCC,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'RCL'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) RDL,
            SUM(
            ...
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'RET'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) RTN,
            SUM(
            ...
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'SORT'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) SRT_AND_SEG_CHG,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = '685'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) SPL_DEL,
            SUM(
            ...
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'SRG'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) STG,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'CUS7'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END)                     TEM_SRV,
            ...
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'FFF'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) TRD_SHW_XPO_DEL,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'VOR'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) TRK_ORD_NOT_USD,
            SUM(
            ...
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'UNL'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) NLD_FEE,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'WTG'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) WTG_WAT_TIM,
            SUM(
            ...
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'DEL'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) WND_DEL_CHG,
            SUM(
                CASE
                    WHEN TMS_LOA_LNE_CRG.CRG_IDT_COD = 'HDW'
                    THEN TMS_LOA_LNE_CRG.PAY_VAL
                    ELSE 0
                END) WND_HLD_CHG
        FROM
            V_PBI_D_TMS_LOA_LNE_CRG TMS_LOA_LNE_CRG
        GROUP BY
            LOA_IDT_COD,
            SHP_LEG_IDT_COD ) TMS_LOA_LNE_CRG
ON
    (
...
(  select
        TMS_LOA_LNE_STS_RSN.LOA_IDT_COD  LOA_IDT_COD,
        TMS_LOA_LNE_STS_RSN.SHP_LEG_IDT_COD  SHP_LEG_IDT_COD,
        TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD    SHP_LEG_STS_RSN_COD,
        sum((Case when TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD = 'AF' then 1 else 0 end))  ACD
    FROM
        V_PBI_D_TMS_LOA_LNE_STS_RSN TMS_LOA_LNE_STS_RSN
    GROUP BY
            TMS_LOA_LNE_STS_RSN.LOA_IDT_COD,
            TMS_LOA_LNE_STS_RSN.SHP_LEG_IDT_COD,
            TMS_LOA_LNE_STS_RSN.SHP_LEG_STS_RSN_COD ) TMS_LOA_LNE_STS_RSN
ON
    (
...
LEFT JOIN DEV_NAM.NAM_STG_MDS.R_DST_CPS_TMS TMS_LOA_LNE_DST_CPS
ON TMS_LOA_LNE.SHP_LEG_DRP_CBU_COD = TMS_LOA_LNE_DST_CPS.DST_ID

-- left join mds campus origin table:
LEFT JOIN DEV_NAM.NAM_STG_MDS.R_ORN_CPS_TMS TMS_LOA_LNE_ORN_CPS
ON TMS_LOA_LNE.SHP_LEG_PIC_CBU_COD = TMS_LOA_LNE_ORN_CPS.ORN_ID
WHERE
    (
...
GROUP BY
    ...
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_DRP_APP_CRE_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_DRP_APP_CRE_TIM END,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_DRP_APP_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_DRP_APP_TIM END,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_DRP_APP_WIN_END_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_DRP_APP_WIN_END_TIM END,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_DRP_APP_WIN_BGN_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_DRP_APP_WIN_BGN_TIM END,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_DRP_ARV_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_DRP_ARV_TIM END,
    TMS_LOA_LNE.SHP_LEG_DRP_CTY_DSC,
    TMS_LOA_LNE.SHP_LEG_DRP_CRY_COD,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_DRP_WIN_BGN_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_DRP_WIN_BGN_TIM END,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_DRP_ADU_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_DRP_ADU_TIM END,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_DRP_DCK_END_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_DRP_DCK_END_TIM END,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_DRP_DCK_BGN_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_DRP_DCK_BGN_TIM END,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_DRP_ARV_GTE_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_DRP_ARV_GTE_TIM END,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_DRP_DEP_GTE_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_DRP_DEP_GTE_TIM END,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_DRP_LOA_END_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_DRP_LOA_END_TIM END,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_DRP_LOA_BGN_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_DRP_LOA_BGN_TIM END,
    TMS_LOA_LNE.SHP_LEG_DRP_STE_COD,
    TMS_LOA_LNE.SHP_LEG_DRP_PST_COD,
    TMS_LOA_LNE.SHP_LEG_DRP_CBU_COD,
    TMS_LOA_LNE.SHP_LEG_DRP_NAM_COD,
    TMS_LOA_LNE.SHP_LEG_INB_OTB_DSC,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_PIC_FNC_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_PIC_FNC_TIM END,
    CASE
        WHEN TMS_LOA_LNE.SHP_LEG_INB_OTB_DSC = 'INBOUND'
        THEN TMS_LOA_LNE.SHP_LEG_DRP_CBU_COD
        ELSE '#'
    END,
    CASE WHEN TO_DATE(TMS_LOA_LNE.LOA_CNL_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.LOA_CNL_TIM END,
    CASE WHEN TO_DATE(TMS_LOA_LNE.LOA_CLO_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.LOA_CLO_TIM END,
    CASE WHEN TO_DATE(TMS_LOA_LNE.LOA_CRE_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.LOA_CRE_TIM END,
    ...
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_PIC_APP_CRE_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_PIC_APP_CRE_TIM END,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_PIC_APP_WIN_END_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_PIC_APP_WIN_END_TIM END,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_PIC_APP_WIN_BGN_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_PIC_APP_WIN_BGN_TIM END,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_PIC_ARV_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_PIC_ARV_TIM END,
    TMS_LOA_LNE.SHP_LEG_PIC_CTY_DSC,
    TMS_LOA_LNE.SHP_LEG_PIC_CRY_COD,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_PIC_ADU_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_PIC_ADU_TIM END,
    TMS_LOA_LNE.SHP_LEG_PIC_NAM_COD,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_PIC_DCK_END_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_PIC_DCK_END_TIM END,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_PIC_DCK_BGN_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_PIC_DCK_BGN_TIM END,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_PIC_ARV_GTE_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_PIC_ARV_GTE_TIM END,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_PIC_DEP_GTE_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_PIC_DEP_GTE_TIM END,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_PIC_LOA_END_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_PIC_LOA_END_TIM END,
    CASE WHEN TO_DATE(TMS_LOA_LNE.SHP_LEG_PIC_LOA_BGN_TIM) = '1000-01-01' THEN NULL ELSE TMS_LOA_LNE.SHP_LEG_PIC_LOA_BGN_TIM END,
    TMS_LOA_LNE.SHP_LEG_PIC_STE_COD,
